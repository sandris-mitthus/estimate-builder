...
**Current version:** `1.3.20` (see [Changelog](#changelog))
...
- **Navigācijas loading** — klikšķis uz izvēlnes saites rāda spinneri un bloķē citas saites līdz `pathname` mainās (`app-nav.tsx`)
...
- Meta layout: bold module name + action icons; **Tāmes piedāvājums** title + **Kopā** total; client, full-width object address; **Plānotā peļņa** (% — palielina Darbs / Materiāli / Mehānismi vienības cenas un kopsummas; apstiprinātā tāmē paliek redzama, bet neaktīva); **Sagatavotājs**, **Datums**, **Tāmes termiņš** in one row (apstiprinātā / pabeigtā tāmē — tikai **Datums**, bez termiņa un atpakaļskaitīšanas)
