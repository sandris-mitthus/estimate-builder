...
**Current version:** `1.3.76` (see [Changelog](#changelog))
...
│   ├── estimates/      # calculate-totals (resolveEstimateLineItemPrices), planned-profit, attention-budget, category-child-order, aggregate-project-materials, material-consumption-basis, collect-estimate-document-units, calculate-line (addThousandSeparators, formatDecimalDisplay), format-money, multi-position, composite-line-item, sync-module-size-quantities, units, …
